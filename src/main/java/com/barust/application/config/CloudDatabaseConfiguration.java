package com.barust.application.config;
...
@Configuration
@EnableMongoRepositories("com.barust.application.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.barust.application.config.dbmigrations");
